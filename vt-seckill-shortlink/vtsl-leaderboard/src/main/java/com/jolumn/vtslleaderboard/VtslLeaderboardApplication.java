package com.jolumn.vtslleaderboard;
...
/**
 * vtsl-leaderboard — 排行榜服务（端口 8084）.
 *
 * <p>承担功能点：
 * <ul>
...
@EnableDubbo
@EnableScheduling
public class VtslLeaderboardApplication {

    static void main(String[] args) {
        SpringApplication.run(VtslLeaderboardApplication.class, args);
    }
}
