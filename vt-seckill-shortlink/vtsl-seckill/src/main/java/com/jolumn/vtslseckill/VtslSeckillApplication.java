package com.jolumn.vtslseckill;
...
@EnableDubbo
@EnableScheduling
public class VtslSeckillApplication {

    static void main(String[] args) {
        SpringApplication.run(VtslSeckillApplication.class, args);
    }
}
