package com.jolumn.vtslseckill.product.config;
...
@EnableJpaRepositories(
        basePackages = "com.jolumn.vtslseckill.product.repository",
...
public class ProductDataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean productEntityManagerFactory(
        ...
        em.setPackagesToScan("com.jolumn.vtslseckill.product.entity");
