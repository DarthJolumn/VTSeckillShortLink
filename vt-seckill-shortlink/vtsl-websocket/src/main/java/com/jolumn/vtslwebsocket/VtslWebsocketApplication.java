package com.jolumn.vtslwebsocket;
...
/**
 * vtsl-websocket — WebSocket 长连接服务.
 *
 * <p>承担功能点：
 * <ul>
 ...
 *       由 {@link com.jolumn.vtslwebsocket.config.WebSocketConfig} 注入 VT Executor</li>
...
@SpringBootApplication(scanBasePackages = {
        "com.jolumn.vtslwebsocket",
        "com.jolumn.vtslcommon"
})
@EnableDubbo
@EnableScheduling
public class VtslWebsocketApplication {

    static void main(String[] args) {
        SpringApplication.run(VtslWebsocketApplication.class, args);
    }
}
